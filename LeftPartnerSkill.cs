...
public class LeftPartnerSkill : MonoBehaviour {
    PlayerState ps;
    Allc allc;
    AllItem allItem;
    float temps;
    ...
    void Update()
    {
        ...
        if (allc.skillavailable == true)
        {
            ...
            if (leftselect == 1 && (Time.time - temps) < 0.1 && ps.L_skillToggle == true)//스킬 판별 1번과 짧은 클릭의 경우 -- 회복 스킬을 사용할 경우
            {
                Skill_Heal();
            ...
            if (leftselect == 2 && (Time.time - temps) < 0.1 && ps.L_skillToggle == true && shakeOn == 0)//스킬 판별 2번과 짧은 클릭의 경우 -- 지진 스킬을 사용할 경우
            {
                Skill_EarthQuake();
            ...
            if (leftselect == 3 && (Time.time - temps) < 0.1 && bombskill_activate == 0 && ps.L_skillToggle == true)//스킬 판별 3번과 짧은 클릭의 경우 -- 폭탄 스킬을 사용할 경우
            {
            ...
            if (leftselect == 4 && (Time.time - temps) < 0.1 && buff_on == false && ps.L_skillToggle == true)//스킬 판별 4번과 짧은 클릭의 경우 -- 슬로우 스킬을 사용할 경우
            {
                buff_on = true;
                slowtime = 3.0f;
    ...
    void Skill_Heal()
    {
        ...
        if (stime > 1.0f)
        {
            skilleffect.transform.GetChild(0).gameObject.SetActive(false);
        }
    }
